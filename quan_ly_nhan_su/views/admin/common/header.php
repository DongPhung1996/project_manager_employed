            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Thông tin <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">                          	
                                <li>
                                    <a href="admin.php?controller=users&action=list">Thông tin nhân viên</a>
                                </li>
                                <li>
                                    <a href="admin.php?controller=users&action=insurrance">Bảo hiểm xã hội</a>
                                </li>
                                <li>
                                    <a href="admin.php?controller=users&action=contract">Hợp đồng lao động</a>
                                </li>
                                <li>
                                    <a href="admin.php?controller=users&action=certification">Giấy chứng nhận</a>
                                </li>
                                <li>
                                    <a href="admin.php?controller=users&action=add">Thêm nhân viên</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin.php?controller=users&action=experience">Kinh nghiệm làm việc</a>
                                </li>
                                <li>
